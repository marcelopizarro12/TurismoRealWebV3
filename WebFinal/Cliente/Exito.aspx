<%@ Page Title="" Language="C#" MasterPageFile="~/Cliente/PrincipalUsuario.Master" AutoEventWireup="true" CodeBehind="Exito.aspx.cs" Inherits="WebFinal.Cliente.Exito" %>
                   ...
                   <form runat="server">
                    <div class="boton1 col-md-12 text-center mb-3">
                     ...
                     <asp:GridView ID="GridView1" runat="server" AllowPaging="False" Visible="false"></asp:GridView>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="False" Visible="false"></asp:GridView>
